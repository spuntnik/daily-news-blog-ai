...
export default function LinkedInPage() {
  ...
  async function generateDrafts() {
    ...
    try {
      ...
      const drafts = buildLinkedInDrafts({
        ...
        toneMode,
        lengthMode,
        source: sourceMode === "blog" ? "Blog" : "Keyword",
      });
  ...
  function exportGeneratedAsCsv() {
    ...
    const rows = [
      ["source", "tone", "length", "angle_name", "hook", "body", "cta", "full_post"],
...
function buildLinkedInDrafts({
  ...
  const attachMeta = (items: Omit<GeneratedDraft, "length" | "source">[]): GeneratedDraft[] =>
    items.map((item) => ({
      ...item,
      source,
      length: lengthMode,
...
function buildBlairDreamDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildBlairValidationDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildBlairEnemyDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildReflectiveQuietDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildReflectiveIdentityDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildReflectivePermissionDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildThoughtLeadershipTrendDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildThoughtLeadershipMisreadDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildThoughtLeadershipShiftDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildContrarianMythDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildContrarianCostDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function buildContrarianSignalDraft(topic: string, summary: string, lengthMode: string): Omit<GeneratedDraft, "length" | "source"> {
  const hook = [
...
function finalizeDraft(
  ...
  body: string,
  cta: string
): Omit<GeneratedDraft, "length" | "source"> {
